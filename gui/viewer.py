...
class Viewer:
  ...
  def __init__( self, simulator ):
    ...
    # align the controls
    sim_controls_alignment = Gtk.Alignment.new( 0.5, 0.0, 0.0, 1.0 )
    map_controls_alignment = Gtk.Alignment.new( 0.5, 0.0, 0.0, 1.0 )
    invisibles_button_alignment = Gtk.Alignment.new( 0.5, 0.0, 0.0, 1.0 )
    ...
    layout_box = Gtk.VBox()
    layout_box.pack_start( self.drawing_area , True, True, 0)
  ...
  def on_draw( self, da, ctx ):
    self.painter.draw_frame( self.current_frame, da, ctx )
